...
export function ProblemWorkspace({ problems }: ProblemWorkspaceProps) {
    ...
    // Initialize sessions when problems change
    useEffect(() => {
        setSessions(
                        ...
                        idx === sessionIdx
                            ? {
                                ...
                                threads: sess.threads.map((t) =>
                                    t.id === threadId
                                        ? { ...t, messages: [...t.messages, aiMsg], unread: true }
                                        : t
                                ),
                            }
                            : sess
    ...
    return (
        <div className="w-full space-y-4">
            ...
            <div
                ...
                style={{ height: panelHeight, minHeight: "70vh" }}
            >
                <div className="space-y-2">
                    ...
                    {activeSession.problem.imageBase64 ? (
                        <div className="rounded-lg border border-border bg-white dark:bg-zinc-900 overflow-hidden w-full max-h-48">
                            {/* eslint-disable-next-line @next/next/no-img-element */}
                            <img
                                src={activeSession.problem.imageBase64}
